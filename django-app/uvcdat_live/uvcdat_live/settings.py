...
DATABASES = {
    'default': {
        ...
        'USER': '',
        'PASSWORD': '',
        'HOST': 'acme-ui.ornl.gov',                      # Empty for localhost through domain sockets or '127.0.0.1' for localhost through TCP.
        'PORT': '8081',                      # Set to empty string for default.
    }
}
...
STATICFILES_DIRS = (
    ...
    "/Users/i7j/DiagnosticsViewer/django-app/uvcdat_live/exploratory_analysis/static/exploratory_analysis",
...
SECRET_KEY = 'd^yp_h*w45gk573p%b(72(=ulqh*jo)ihmg^ik=%*l)^zu1c1v'
...
ROOT_URLCONF = 'uvcdat_live.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'uvcdat_live.wsgi.application'
