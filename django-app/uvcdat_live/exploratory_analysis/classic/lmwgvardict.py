obskeys = {}
obskeys['USAF/ETAC - FOSTERDAVY'] = 'FOSTERDAVY'
obskeys['CMC'] = 'CMC'
vardict={}
vardict['Turbulent_Fluxes']={'RepUnits':'N/A', 'sets':[3, 6],'NatUnits':'N/A', 'desc':'Turbulent Fluxes', 'filekey':'turbf'}
vardict['Total_Precip']={'RepUnits':'N/A', 'sets':[3, 6], 'NatUnits':'N/A', 'desc':'Temp Precip Runoff SnowDP', 'filekey':'landf'}
vardict['Radiative_Fluxes']={'RepUnits':'N/A', 'sets':[3,6], 'NatUnits':'N/A', 'desc':'Radiative Fluxes', 'filekey':'radf'}
vardict['Carbon_Nitrogen_Fluxes']={'RepUnits':'N/A', 'sets':[3,6], 'NatUnits':'N/A', 'desc':'Carbon Nitrogen Fluxes', 'filekey':'cnFlx'}
vardict['Fire_Fluxes']={'RepUnits':'N/A', 'sets':[3,6], 'NatUnits':'N/A', 'desc':'Fire Fluxes','filekey':'frFlx'}
vardict['Soil_Temp']={'RepUnits':'N/A', 'sets':[6], 'NatUnits':'N/A', 'desc':'Soil Temperature','filekey':'tsoi'}
vardict['SoilLiq_Water'] 6={'RepUnits':'N/A', 'sets':[6], 'NatUnits':'N/A', 'desc':'SoilLiq Water', 'filekey':'soilliq'}
vardict['SoilIce']={'RepUnits':'N/A', 'sets':[6], 'NatUnits':'N/A', 'desc':'SoilIce','filekey':'soilice'}
vardict['TotalSoilIce_TotalSoilH2O']={'RepUnits':'N/A', 'sets':[6], 'NatUnits':'N/A', 'desc':'TotalSoilIce TotalSoilH2O','filekey':'soilliqIce'}
vardict['TotalSnowH2O_TotalSnowIce']={'RepUnits':'N/A', 'sets':[6], 'NatUnits':'N/A', 'desc':'TotalSnowH2O TotalSnowIce','filekey':'snowliqIce'}
vardict['Hydrology']={'RepUnits':'N/A', 'sets':[3, 6], 'NatUnits':'N/A', 'desc':'Hydrology','filekey':'hydro'}
vardict['Energy_Moist_Control_of_Evap']={'RepUnits':'N/A', 'sets':[6], 'NatUnits':'N/A', 'desc':'Energy/Moist Control of Evap','filekey':'moistEnergyFlx'}
vardict['Snow_vs_Obs']={'RepUnits':'N/A', 'sets':[6], 'NatUnits':'N/A', 'desc':'Snow vs Obs','filekey':'snow'}
vardict['Albedo_vs_obs']={'RepUnits':'N/A', 'sets':[6], 'NatUnits':'N/A', 'desc':'Albedo vs Obs','filekey':'albedo'}
vardict['PFT_FIRE_CLOSS']={'RepUnits': 'PgC/y', 'sets': [1, 2, 3, 5, 6], 'NatUnits': 'gC/m^2/s', 'desc': 'total pft-level fire C loss'}
vardict['SNOWDP']={'RepUnits': 'NA', 'sets': [2, 3, 5, 6], 'datasets':['USAF/ETAC - FOSTERDAVY','CMC'], 'NatUnits': 'm', 'desc': 'snow height'}
...
vardict['NBSA']={'RepUnits': 'NA', 'sets': [2, 3, 5],'datasets':['MODIS'],  'NatUnits': 'proportion', 'desc': 'near-IR black-sky albedo'}
...
vardict['FSNO']={'RepUnits': 'NA', 'sets': [2, 3, 5], 'datasets':['NOAA-AVHRR'], 'NatUnits': 'unitless', 'desc': 'fraction of ground covered by snow'}
...
vardict['VWSA']={'RepUnits': 'NA', 'sets': [2, 3, 5], 'datasets':['MODIS'], 'NatUnits': 'proportion', 'desc': 'visible white-sky albedo'}
...
vardict['TSA']={'RepUnits': 'K', 'sets': [1, 2, 3, 5, 6, 9], 'datasets':['Willmott-Matsuura'], 'NatUnits': 'K', 'desc': '2m air temperature'}
vardict['QDRIP']={'RepUnits': 'mm/y', 'sets': [2], 'NatUnits': 'mm/s', 'desc': 'throughfall'}
vardict['PREC']={'RepUnits': 'mm/d', 'sets': [1, 2, 3, 5, 6, 9], 'datasets':['Willmott-Matsuura'], 'NatUnits': 'mm/s', 'desc': 'ppt: rain+snow'}
...
vardict['ASA']={'RepUnits': 'NA', 'sets': [2, 3, 9], 'datasets':['MODIS'], 'NatUnits': 'proportion', 'desc': 'all-sky albedo:FSR/FSDS'}
...
vardict['TOTRUNOFF']={'RepUnits': 'mm/d', 'sets': [1, 2, 3, 5, 6], 'datasets':['GRDC'], 'NatUnits': 'mm/s', 'desc': 'Runoff:qover+qdrai+qrgwl'}
...
vardict['VBSA']={'RepUnits': 'NA', 'sets': [2, 3, 5], 'datasets':['MODIS'], 'NatUnits': 'proportion', 'desc': 'visible black-sky albedo'}
...
vardict['H2OSNO']={'RepUnits': 'NA', 'sets': [2, 3, 5], 'datasets':['CMC'], 'NatUnits': 'mm', 'desc': 'total snow water equiv (SNOWICE + SNOWLIQ)'}
...
vardict['NWSA']={'RepUnits': 'NA', 'sets': [2, 3, 5], 'datasets':['MODIS'], 'NatUnits': 'proportion', 'desc': 'near-IR white-sky albedo'}
